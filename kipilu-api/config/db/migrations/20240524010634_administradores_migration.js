exports.up = function(knex) {
  return knex.schema.createTable('Administradores', function(table) {
    ...
    table.string('Contrasena', 60).notNullable(); // Aumenta la longitud para almacenar el hash
  })
  .then(function() {
    // Insertar datos
    return knex('Administradores').insert([
      { 
        ...
        P_Apellido: 'Cruz',
        S_Apellido: 'Zapata',
        Contrasena: 'F0rm5', // Aquí debería ir el hash de la contraseña
      },
      { 
        ...
        P_Apellido: 'Ramírez',
        S_Apellido: 'Beltrán',
        Contrasena: 'jfrb1234', // Aquí debería ir el hash de la contraseña
      }
    ]);
  });
};
